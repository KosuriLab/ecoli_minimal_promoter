...
# Figure 3A
split_exp$UP_element <- with(split_exp, reorder(UP_element,RNA_exp_12, max))

ggplot(filter(split_exp, Minus10 == 'consensus10', 
              Minus35 == 'consensus35', 
              Background != 'bg4323949:4324099', 
              Background != 'bg977040:977190'), 
       aes(x = Spacer, y = Background)) + 
...
# Figure 3B
ggplot(filter(split_exp, UP_element == 'gourse-136fold-up', 
              Background != 'bg4323949:4324099', 
              Background != 'bg977040:977190'), 
       aes(x = Spacer, y = Background)) + 
  geom_tile(aes(fill = log10(RNA_exp_12))) + 
